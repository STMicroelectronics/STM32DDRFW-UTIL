/**
  * STM32MP157C DDR3 4Gb configuration
...
#define DDR_DRAMTMG1 0x000A041CU
#define DDR_DRAMTMG2 0x0608090FU
#define DDR_DRAMTMG3 0x0050400CU
#define DDR_DRAMTMG4 0x08040608U
...
#define DDR_DFITMG0 0x02060105U
...
#define DDR_ADDRMAP5 0x06060606U
#define DDR_ADDRMAP6 0x0F060606U
...
#define DDR_SCHED 0x00000C01U
#define DDR_SCHED1 0x00000000U
#define DDR_PERFHPR1 0x01000001U
#define DDR_PERFLPR1 0x08000200U
...
#define DDR_PCFGR_0 0x00010000U
#define DDR_PCFGW_0 0x00000000U
#define DDR_PCFGQOS0_0 0x02100C03U
#define DDR_PCFGQOS1_0 0x00800100U
#define DDR_PCFGWQOS0_0 0x01100C03U
#define DDR_PCFGWQOS1_0 0x01000200U
#define DDR_PCFGR_1 0x00010000U
#define DDR_PCFGW_1 0x00000000U
#define DDR_PCFGQOS0_1 0x02100C03U
#define DDR_PCFGQOS1_1 0x00800040U
#define DDR_PCFGWQOS0_1 0x01100C03U
#define DDR_PCFGWQOS1_1 0x01000200U
...
#define DDR_DX2GCR 0x0000CE80U
#define DDR_DX3GCR 0x0000CE80U
