...
/** @defgroup STM32MP257F_DK_BUS_Exported_Constants BUS Exported Constants
  ...
  */
  ...
  /* Definition for I2C clock resources */
    ...
    #define BUS_I2C                             I2C1
    #define BUS_I2C_RIFSC_ID                    STM32MP25_RIFSC_I2C1_ID
    ...
    #define BUS_I2C                             I2C2
    #define BUS_I2C_RIFSC_ID                    STM32MP25_RIFSC_I2C2_ID
    ...
    #define BUS_I2C                             I2C3
    #define BUS_I2C_RIFSC_ID                    STM32MP25_RIFSC_I2C3_ID
    ...
    #define BUS_I2C                             I2C4
    #define BUS_I2C_RIFSC_ID                    STM32MP25_RIFSC_I2C4_ID
    ...
    #define BUS_I2C                             I2C5
    #define BUS_I2C_RIFSC_ID                    STM32MP25_RIFSC_I2C5_ID
    ...
    #define BUS_I2C                             I2C6
    #define BUS_I2C_RIFSC_ID                    STM32MP25_RIFSC_I2C6_ID
    ...
    #define BUS_I2C                             I2C7
    #define BUS_I2C_RIFSC_ID                    STM32MP25_RIFSC_I2C7_ID
    ...
    #define BUS_I2C                             I2C8
    #define BUS_I2C_RIFSC_ID                    STM32MP25_RIFSC_I2C8_ID
