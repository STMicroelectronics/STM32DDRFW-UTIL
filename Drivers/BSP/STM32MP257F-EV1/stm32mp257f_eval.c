...
/** @defgroup STM32MP257F_EVAL_LOW_LEVEL LOW LEVEL
  * @{
  */

/** @defgroup STM32MP257F_EVAL_LOW_LEVEL_Private_TypesDefinitions  Private Types Definitions
  * @{
  */
...
/** @defgroup STM32MP257F_EVAL_LOW_LEVEL_Private_FunctionPrototypes  Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32MP257F_EVAL_LOW_LEVEL_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32MP257F_EVAL_LOW_LEVEL_Private_Variables Private Variables
  * @{
  */
#if defined (CORE_CA35) || defined (CORE_CM33)
...
/** @defgroup STM32MP257F_EVAL_LOW_LEVEL_Exported_Functions Exported Functions
  * @{
  */
...
static void USART_MspInit(UART_HandleTypeDef *huart)
{
  ...
  {
    /* UART5 clock config */
    ResMgr_Request(RESMGR_RESOURCE_RIFSC, STM32MP25_RIFSC_UART5_ID);
    /* Enable UART clock */
    COM_CM33_CLK_ENABLE();
