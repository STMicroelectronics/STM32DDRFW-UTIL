...
HAL_StatusTypeDef HAL_USART_Transmit_DMA(USART_HandleTypeDef *husart, const uint8_t *pTxData, uint16_t Size)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    if (husart->hdmatx != NULL)
    {
      ...
      {
        /* Enable the USART transmit DMA channel */
        status = HAL_DMA_Start_IT(husart->hdmatx, *(const uintptr_t *)tmp, (uintptr_t)&husart->Instance->TDR, nbByte);
      }
    }
...
HAL_StatusTypeDef HAL_USART_Receive_DMA(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    if (husart->hdmarx != NULL)
    {
      ...
      {
        /* Enable the USART receive DMA channel */
        status = HAL_DMA_Start_IT(husart->hdmarx, (uintptr_t)&husart->Instance->RDR, *(uintptr_t *)tmp, nbByte);
      }
    }
        ...
        (husart->SlaveMode == USART_SLAVEMODE_DISABLE))
    {
      ...
      if (husart->hdmatx != NULL)
      {
        ...
        {
          status = HAL_DMA_Start_IT(husart->hdmatx, *(uintptr_t *)tmp, (uintptr_t)&husart->Instance->TDR, nbByte);
        }
      }
    }
                                                ...
                                                uint16_t Size)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    if ((husart->hdmarx != NULL) && (husart->hdmatx != NULL))
    {
      ...
      {
        /* Enable the USART receive DMA channel */
        status = HAL_DMA_Start_IT(husart->hdmarx, (uintptr_t)&husart->Instance->RDR, *(const uintptr_t *)tmp, nbByte);
      }
